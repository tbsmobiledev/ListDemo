...
open class AZImagePresenterViewController: UIViewController{
    ...
    open func embedInNavigation()->UINavigationController{
        ...
        //For text: UIBarButtonItem(title: "Close", style: .done, target: self, action: #selector(done(_:)))
    ...
    fileprivate func presentView(){
        ...
        if isRounded{
            ...
            self.imageView!
                .addCornerRadiusAnimation(from: imageView!.cornerRadius1,
    ...
    fileprivate func dismissDirection(_ baseView: TrackableImage , scale: CGFloat, finalPoint: CGPoint){
        ...
        baseView.addCornerRadiusAnimation(from: baseView.cornerRadius1, to: originalImage!.cornerRadius1 * (1/scale), duration: animationDuration)
